...
<html>
  <head>
    <title>Place Autocomplete Hospital Search</title>
  ...
  <body>
      ...
      var countries = {
        ...
        'us': {
          ...
          zoom: 3
				...
				'IN': {
          center: {lat: 18.2153746,, lng: 79.391605},
          zoom: 3
        },
        'uk': {
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDQ1znESH60UKBuOMSyBu6WgLcNrv6WiS0&libraries=places&callback=initMap"
        async defer></script>
  </body>
</html>